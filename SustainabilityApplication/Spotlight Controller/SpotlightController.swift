...
//
//  Created by Chandler on 8/20/18.
...
class SpotlightController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        let dennisPost = Post()
        dennisPost.name = "Changing for a reason"
        dennisPost.statusText = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."
        dennisPost.profileImageName = "dennis"
        
        posts.append(dennisPost)
        
        navigationItem.title = "Spotlight"
        navigationItem.leftBarButtonItem = UIBarButtonItem(image: UIImage(named: "Back"), style: .plain, target: self, action: #selector(dismissController))
...
class FeedCell: UICollectionViewCell {
    ...
    var post: Post? {
        didSet {
            ...
            if let name = post?.name {
                ...
                attributeText.append(NSAttributedString(string: "\nDecember 18", attributes: [NSAttributedStringKey.font: UIFont.boldSystemFont(ofSize: 12), NSAttributedStringKey.foregroundColor: UIColor(r: 155, g: 161, b: 161)]))
    ...
    let likesCommentLabel: UILabel = {
        let label = UILabel()
        label.text = "234 Likes • 0 Dislikes"
    ...
    let commentButton: UIButton = FeedCell.buttonForTitle(title: "Share", imageName: "news")
